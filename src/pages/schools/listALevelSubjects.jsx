...
function ListALevelSubjectsPage() {
    const [payload, setPayload] = useState("")

    async function getData() {
        try {
          const url = `${baseUrl}/alevel-subjects`; // Specify your API URL
  ...
  return (
    <div>
        <h1 className="md:text-[40px] text-[25px] font-bold">List A{"'"} Level Subject</h1>
...
export default ListALevelSubjectsPage

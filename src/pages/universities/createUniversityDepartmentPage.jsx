...
function CreateUniversityDepartmentPage() {
  return (
    <div>
        <h1 className="md:text-[40px] text-[25px] font-bold">Create university departments</h1>
...
export default CreateUniversityDepartmentPage

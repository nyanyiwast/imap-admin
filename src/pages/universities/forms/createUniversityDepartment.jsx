...
const formSchema = z.object({
    departmentName: z.string().min(5, {
    message: "Field is mandatory and must be valid",
  })
  })

export function CreateUniversityDepartment() {
...
async function onSubmit(values) {
  setLoading(true)
  const { facultyId } = form.getValues(); // Access the provinceId value
  const updatedValues = { ...values, facultyId }; // Include provinceId in the values object

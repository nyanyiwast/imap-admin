...
async function onSubmit(values) {
  ...
  try {
    const url = `${baseUrl}/currencies`; // Specify your API URL
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="ZiG" {...field} />
              </FormControl>
              <FormDescription>Please note that the system base currency is set to USD and there is no need to create it again</FormDescription>
              <FormMessage />
            </FormItem>
